...
<div class="pl-2 flex flex-col md:flex-row">
	<div class="flex-auto p-4 shadow-lg">
		...
		<h3 class="text-lg font-mono pt-2 font-medium">Additional Chosen Feature</h3>
		<ul class="pl-4">
			<li class="underline hover:no-underline hover:text-blue-800">
				<a href="inventory/delete">When deleting, allow deletion comments and undeletion </a>
			</li>
		</ul>
	</div>
